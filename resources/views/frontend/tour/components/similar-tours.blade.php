        ...
        <div class="col">
            ...
            <figure class="tour-grid-item-01">
                ...
                <a href="#">
                    ...
                    <div class="image">
                        <img src="{{asset('frontend/images/image-bg/01.jpg')}}" alt="images"/>
                    </div>
                    ...
                    <figcaption class="content">
                        ...
                        <p class="mt-3">Price from <span
                                class="h6 line-1 text-primary font16">$125.99</span> <span
        ...
        <div class="col">
            ...
            <figure class="tour-grid-item-01">
                ...
                <a href="#">
                    ...
                    <div class="image">
                        <img src="{{asset('frontend')}}/images/image-bg/02.jpg" alt="images"/>
                    </div>
                    ...
                    <figcaption class="content">
                        ...
                        <ul class="item-meta mt-15">
                            ...
                            <li>
                                Start/End: <span
                                    class="font600 h6 line-1 mv-0"> Kathmandu</span>
                            </li>
                        </ul>
                        <p class="mt-3">Price from <span
                                class="h6 line-1 text-primary font16">$125.99</span> <span
